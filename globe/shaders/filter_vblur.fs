...
//  vec2 fcoord = vec2(0.0, 0.0);
  ...
  texc+=texture2D(tex0, vec2(texcoordout.x, texcoordout.y - 4.0*blurSize)) * 0.05;
  texc+=texture2D(tex0, vec2(texcoordout.x, texcoordout.y - 3.0*blurSize)) * 0.09;
  texc+=texture2D(tex0, vec2(texcoordout.x, texcoordout.y - 2.0*blurSize)) * 0.12;
  texc+=texture2D(tex0, vec2(texcoordout.x, texcoordout.y - blurSize)) * 0.15;
